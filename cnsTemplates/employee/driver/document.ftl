			...
			<div class="row">
				...
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li>
							<a href="/employee/driver">Drivers</a>
						</li>
						<li class="active">${(driver.firstName)!} ${(driver.lastName)!}</li>
						<li class="active">Documents</li>
						<#if !addnew??>
							<li>
								<a href="/employee/driver/${(driver.id)!}/document?addnew"><i class="fa fa-plus">&nbsp;Add New</i></a>
							</li>
						</#if>
					</ol>
				</div>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							...
							<a href="/employee/driver/${(driver.id)!}/document" class="btn btn-default btn-xs pull-right">Cancel</a>
						</div>
						<#--<div class="panel-body">-->
							<div id="documents" class="list-group">
								...
								<div class="list-group-item">
									<form id="documentForm" class="test-center" role="form" method="post" action="/employee/driver/${(driver.id?c)!}/document">
											...
											<tr>
												...
												<td>
													<a href="#" class="btn btn-danger btn-xs delete-button"
													   data-delete="/employee/driver/${driver.id}/document/${(document.id)!}"
