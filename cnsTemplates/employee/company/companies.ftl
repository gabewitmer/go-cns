			...
			<div class="row">
				...
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<#if !addnew??>
							<li>
								<a href="/employee/company?addnew"><i class="fa fa-plus">&nbsp;Add New</i></a>
							</li>
						</#if>
					</ol>
				</div>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							Company
							<a href="/employee/company" class="btn btn-default btn-sm pull-right">Cancel</a>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" action="/employee/company" method="post">
								...
								<div class="col-lg-12">
									...
									<#if company??>
										<div class="form-group">
											<a href="#" data-message="Are you sure you would like to permanently delete this company?" data-delete="/employee/company/${(company.id)!}" class="btn btn-danger btn-block delete-button">Delete</a>
										</div>
									</#if>
								</div>
							</form>
								...
								<table id="companies" class="table table-striped table-bordered">
									...
									<tbody>
										<#list companies as company>
											<tr>
												<td><a href="/employee/company/${(company.id)!}" class="btn btn-primary btn-xs">${(company.id)!}</a></td>
												<td>${(company.name)!}</td>
