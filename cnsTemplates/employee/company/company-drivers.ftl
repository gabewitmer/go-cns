			...
			<div class="row">
				...
				<div class="col-lg-12">
					<ol class="breadcrumb">
						...
						<li class="active">
							${(driver??)?string('<a href="/employee/company/${(company.id)!}/driver">Drivers</a>','Drivers')!}
						</li>
						<#if !addnew?? && !driver??>
							<li>
								<a href="/employee/company/${(company.id)!}/driver?addnew"><i class="fa fa-plus">&nbsp;Add New</i></a>
							</li>
						<#else>
				...
				<div class="col-lg-4">
					<div class="panel panel-default">
						<div class="panel-heading clearfix">
							...
							<a href="/employee/company/${(company.id)!}/driver" class="btn btn-default btn-xs pull-right">Cancel</a>
						</div>
						<div class="panel-body">
							<form class="form-horizontal" action="/employee/company/${(company.id)!}/driver/${(addnew??)? string('add', 'edit')}" method="post">
								...
								<div class="col-lg-12">
									...
									<#if driver??>
										<div class="form-group">
											<a href="#" data-message="Are you sure you would like to delete this driver?" data-delete="/employee/company/${(company.id)!}/driver/${(driver.id)!}" class="btn btn-danger btn-block delete-button">Delete</a>
										</div>
									</#if>
								</div>
							</form>
								...
								<table id="drivers" class="table table-striped table-bordered">
									...
									<tbody>
										<#list drivers as driver>
											<tr>
												<td>
													<a href="/employee/company/${(company.id)!}/driver/${(driver.id)!}" class="btn btn-primary btn-xs">${(driver.id)!}</a>
												</td>
