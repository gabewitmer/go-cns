				...
				<div class="col-lg-12">
					...
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-lg-6">
								<input type="text" name="training-administrator-name" class="form-control input-sm">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label left col-lg-2">Signature:</label>
							<div class="col-lg-6">
								<input type="text" name="training-administrator-agreement-signature" class="form-control input-sm">
							</div>
							<label class="control-label left col-lg-1">Date:</label>
							<div class="col-lg-3">
								<input type="text" name="training-administrator-agreement-date" class="form-control input-sm">
							</div>
						</div>
					</div>
				</div>
